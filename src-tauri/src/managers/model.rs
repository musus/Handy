    ...
    pub fn new(app_handle: &AppHandle) -> Result<Self> {
        ...
        available_models.insert(
            ...
            ModelInfo {
                ...
                source: ModelSource::Url {
                    url: "https://github.com/musus/Handy/releases/download/v0.8.0-moonshine-ja/moonshine-base-ja.tar.gz".to_string(),
                    sha256: Some(
                        "7368a29eeeb189ea1b3132b191fcbfbfe11d97f31ed19230c8e587a254617072"
                            .to_string(),
                    ),
                },
                size_mb: 134,
